...
//     axios.post("http://localhost:5000/doc_login", data)
//       .then((res) => {
...
//           <h2 className="my-3">Doctors Login</h2>
//           <div className="mb-3">
//             <input
//               type="email"
...
//           </div>
//           <p>
//             Doesnt have an account? <a href="/doc_signup">Signup</a>
//           </p>
...
export default function Dlogin() {
  ...
  const handleSubmit = (event) => {
    ...
    const dat = {
          ...
          axios.post(`${API_LINK}/doc_login`, dat)
      .then((res) => {
          ...
          >
            ...
            <Box component="form"  noValidate onSubmit={handleSubmit} sx={{ mt: 1 }}>
              ...
              <Grid container>
                ...
                <Grid item>
                  <Link href="/doc_signup" variant="body2">
